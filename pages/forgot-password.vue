                ...
                <BCard no-body class="mb-0 border-0 shadow-none mb-0">
                  <BCardBody class="p-sm-5 m-lg-4">
                    <div class="text-center mt-2">
                      ...
                      <p class="text-muted mb-4">Reset password with Rodelas Residence Space and Leasing</p>
                      <div class="pb-4">
                    ...
                    <div class="mt-4 text-center">
                      <p class="mb-0">Wait, I remember my password... <nuxt-link to="/login"
                          class="fw-semibold text-primary text-decoration-underline"> Click here </nuxt-link> </p>
                    </div>
                  </BCardBody>
                </BCard>
                <div v-for="(item, index) in v$.email.$errors" :key="index" class="invalid-feedback">
