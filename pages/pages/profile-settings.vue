...
export default {
  ...
  data() {
    return {
      ...
      // MultiSelect
      skillSelectValue: [{ value: "javascript", label: "Javascript" }],
      skillOptions: [
      ...
      addmissionSelectValue: [{ value: "Choice 17", label: "2017" }],
      passedSelectValue: { value: "Choice 20", label: "2020" },
      passedOptions: [
      ...
      <BCard no-body class="overflow-hidden">
        <div>
          ...
          <div>
            ...
            >
              <i class="ri-image-edit-line align-bottom me-1" /> Edit Cover
              Images
            </label>
          </div>
        </div>
        <BCardBody class="pt-0 mt-n5">
          <div class="text-center">
            ...
            <div class="d-flex gap-2 mt-4">
              <BButton variant="subtle-secondary" class="text-truncate w-50"
          ...
          <div class="d-flex align-items-center mb-4 pb-2">
            <div class="flex-grow-1">
              <BCardTitle title-tag="h5" class="mb-0"
                >Complete Your Profile</BCardTitle
              >
            </div>
            <div class="flex-shrink-0">
              <BLink href="#" class="badge bg-light text-secondary"
                ><i class="ri-edit-box-line align-bottom me-1" /> Edit</BLink
              >
            </div>
          </div>
          <div
        ...
        <BCardBody class="border-top">
          <div class="d-flex align-items-center mb-4">
            <div class="flex-grow-1">
              <BCardTitle title-tag="h5" class="mb-0">Portfolio</BCardTitle>
            </div>
            <div class="flex-shrink-0">
              <BLink href="#" class="badge bg-info-subtle text-info fs-12"
                ><i class="ri-add-fill align-bottom me-1" /> Add</BLink
              >
            </div>
          </div>
    ...
    <BCol xxl="9">
      <div class="d-flex align-items-center flex-wrap gap-2 mb-4">
        ...
        >
          ...
          <li class="nav-item" role="presentation">
            <BLink
              ...
              tabindex="-1"
              :class="{
                active: activeTab === 'securityPrivacy'
              }"
              @click="activeTab = 'securityPrivacy'"
            >
              Security & Privacy
            </BLink>
          </li>
        ...
        <div class="flex-shrink-0 ms-auto order-1 order-lg-2">
          <nuxt-link to="/pages/profile-settings" class="btn btn-secondary"
            ><i class="bi bi-pencil-square align-baseline me-1" /> Edit
            Profile</nuxt-link
          >
        </div>
      </div>
                  ...
                  <BCol lg="12">
                    <div class="mb-3 pb-2">
                      ...
                      <textarea
                        ...
                        rows="5"
                      >
A Web Developer creates and
                                            designs different websites for clients. They are responsible for their
                                            aesthetic as well as their function. Professionals in this field may also
                                            need to be able to ensure sites are compatible with multiple types of media.
                                            Web Developers need to have a firm understanding of programming and
                                            graphical design. Having a strong resume that emphasizes these attributes
                                            makes it significantly easier to get hired as a Web Developer. As a web
                                            designer, my objective is to make a positive impact on clients, co-workers,
                                            and the Internet using my skills and experience to design compelling and
                                            attractive websites. Solving code problems. Editing & Design with designing
                  ...
                  <BCol lg="12">
                    <div class="hstack gap-2 justify-content-end">
                      <BButton type="submit" variant="primary">Updates</BButton>
                      <BButton variant="subtle-danger">Cancel</BButton>
                    </div>
                  </BCol>
                </BRow>
              </form>
          ...
          >
            <BCardHeader>
              <BCardTitle title-tag="h6" class="mb-0"
                >Changes Password</BCardTitle
              >
            </BCardHeader>
            <BCardBody>
              <form action="/pages/profile-settings">
                <BRow class="g-2 justify-content-lg-between align-items-center">
                  <BCol lg="4">
                    <div>
                      ...
                      <div class="position-relative">
                        ...
                        <BButton
                          variant="link"
                          class="position-absolute top-0 end-0 text-decoration-none text-muted password-addon"
                          id="password-addon"
                  ...
                  <BCol lg="12">
                    <BCard
                      class="bg-light shadow-none passwd-bg"
                      id="password-contain"
                    >
                      <BCardBody>
                        <div class="mb-4">
              ...
              >
                <BCardTitle title-tag="h5" class="mb-0"
                  >Login History</BCardTitle
                >
                <div class="flex-shrink-0">
                  <BButton variant="secondary">All Logout</BButton>
                </div>
              </div>
              ...
              <BRow>
                <BCol lg="12">
                  <div class="table-responsive">
                    <BTableSimple class="table-borderless align-middle mb-0">
                      <BThead class="table-light">
                        <BTr>
                          <BTh scope="col">Mobile</BTh>
                          <BTh scope="col">IP Address</BTh>
                      ...
                      <tbody>
                        <BTr>
                          <BTd>
                            <i class="bi bi-phone align-baseline me-1" />
                            iPhone 12 Pro
                          </BTd>
                          <BTd>192.44.234.160</BTd>
                          <BTd>18 Dec, 2023</BTd>
                          <BTd>Los Angeles, United States</BTd>
                          <BTd>
                            <BLink href="#" class="icon-link icon-link-hover"
                              >Logout <i class="bi bi-box-arrow-right"
                            /></BLink>
                          </BTd>
                        </BTr>
                        ...
                        <BTr>
                          <BTd>
                            <i class="bi bi-tablet align-baseline me-1" />
                            Apple iPad Pro
                          </BTd>
                          <BTd>192.44.234.162</BTd>
                          <BTd>03 Jan, 2023</BTd>
                          <BTd>Phoenix, United States</BTd>
                          <BTd>
                            <BLink href="#" class="icon-link icon-link-hover"
                              >Logout <i class="bi bi-box-arrow-right"
                            /></BLink>
                        ...
                        <BTr>
                          ...
                          <BTd>192.45.234.54</BTd>
                          <BTd>25 Feb, 2023</BTd>
                          <BTd>Washington, United States</BTd>
                          <BTd>
                            <BLink href="#" class="icon-link icon-link-hover"
                              >Logout <i class="bi bi-box-arrow-right"
                            /></BLink>
                        ...
                        <BTr>
                          <BTd>
                            <i class="bi bi-laptop align-baseline me-1" />
                            Dell Inspiron 14
                          </BTd>
                          <BTd>192.40.234.32</BTd>
                          <BTd>16 Oct, 2022</BTd>
                          <BTd>Phoenix, United States</BTd>
                          <BTd>
                            <BLink href="#" class="icon-link icon-link-hover"
                        ...
                        <BTr>
                          ...
                          <BTd>192.44.326.42</BTd>
                          <BTd>22 May, 2022</BTd>
                          <BTd>Conneticut, United States</BTd>
                          <BTd>
                            <BLink href="#" class="icon-link icon-link-hover"
                              >Logout <i class="bi bi-box-arrow-right"
                            /></BLink>
          ...
          >
            <BCardHeader>
              <BCardTitle title-tag="h6" class="mb-0">Education</BCardTitle>
            </BCardHeader>
            <BCardBody>
              <BForm>
                <div id="newlink">
                  <div id="1">
                    <BRow>
                      <BCol lg="12">
                        <div class="mb-3">
                          <label for="degreeName" class="form-label"
                            >Degree Name</label
                          >
                          <input
                            type="text"
                      ...
                      <BCol lg="6">
                        <div class="mb-3">
                          <label for="passedYear" class="form-label"
                            >Passed Years</label
                          >
                      ...
                      <BCol lg="12">
                        <div class="mb-3">
                          <label for="degreeDescription" class="form-label"
                            >Degree Description</label
                          >
                          <textarea
                            class="form-control"
                      ...
                      <div class="hstack gap-2 justify-content-end">
                        <BLink class="btn btn-danger" href="#">Delete</BLink>
                      </div>
                    </BRow>
                  </div>
                </div>
                ...
                <BCol lg="12">
                  <div class="hstack gap-2">
                    <BButton type="submit" variant="secondary">Update</BButton>
                    <BLink href="#" class="btn btn-primary">Add New</BLink>
                  </div>
                </BCol>
              </BForm>
            </BCardBody>
            ...
            <BCardBody>
                ...
                <div class="d-flex flex-column flex-sm-row mb-4 mb-sm-0">
                  <div class="flex-grow-1">
                    ...
                    <p class="text-muted">
                      ...
                      identification when you log into Google Authentication and
                      SMS are Supported.
                    </p>
                  </div>
                  <div class="flex-shrink-0 ms-sm-3">
                    <BLink href="#" class="btn btn-sm btn-primary"
                      >Enable Two-factor Authentication</BLink
                    >
                  </div>
                </div>
                ...
                <div class="d-flex flex-column flex-sm-row mb-4 mb-sm-0 mt-2">
                  <div class="flex-grow-1">
                    ...
                    <p class="text-muted mb-sm-0">
                      A backup code is automatically generated for you when you
                      turn on two-factor authentication through your iOS or
                      Android Twitter app. You can also generate a backup code
                      on twitter.com.
                    </p>
                  </div>
                  <div class="flex-shrink-0 ms-sm-3">
              ...
              <div class="mb-3">
                <BCardTitle
                  ...
                  >Application Notifications:</BCardTitle
                >
                <ul class="list-unstyled mb-0">
                  <li class="d-flex">
                    <div class="flex-grow-1">
                      <label for="directMessage" class="form-check-label fs-md"
                  ...
                  <li class="d-flex mt-2">
                    <div class="flex-grow-1">
                      <label
                        class="form-check-label fs-md mb-1"
                  ...
                  <li class="d-flex mt-2">
                    <div class="flex-grow-1">
                      ...
                      <p class="text-muted">
                        ...
                        account, choose the account to enable notifications for.
                      </p>
                    </div>
                    <div class="flex-shrink-0">
                      <div class="form-check form-switch">
                  ...
                  <li class="d-flex mt-2">
                    <div class="flex-grow-1">
                      ...
                      <p class="text-muted">
                        To prevent duplicate mobile notifications from the Gmail
                        and Chat apps, in settings, turn off Chat notifications.
                      </p>
                    </div>
                    <div class="flex-shrink-0">
                      <div class="form-check form-switch">
              ...
              <div>
                <BCardTitle
                  title-tag="h5"
                  class="text-decoration-underline mb-3"
                  >Delete This Account:</BCardTitle
                >
                <p class="text-muted">
                ...
                <div>
                  <input
                    ...
                    value="richard@321654987"
                    style="max-width: 265px"
                  />
                </div>
                <div class="hstack gap-2 mt-3">
                  <BLink href="#" class="btn btn-subtle-danger"
                    >Close & Delete This Account</BLink
                  >
                  <BLink href="#" class="btn btn-light">Cancel</BLink>
                </div>
              </div>
            </BCardBody>
          </div>
