      ...
      <BCard no-body class="overflow-hidden">
        <div class="bg-primary pb-0">
          ...
          <BCardBody class="py-2 bg-white bg-opacity-10">
            ...
            >
              <li>Our term & conditions hes been updaed</li>
              <li>25, March 2023</li>
            </ul>
          </BCardBody>
        </div>
        <BCardBody>
          ...
          <BCardTitle title-tag="h6" class="mb-3"
            ><i class="bi bi-circle-square align-baseline me-1 text-info" />
            Intellectual Property Rights</BCardTitle
          >
          <p class="text-muted mb-2">
            ...
            materials contained in this Themesbrand.
          </p>
          <p class="text-muted">
          ...
          <BCardTitle title-tag="h6" class="mb-3"
            ><i class="bi bi-circle-square align-baseline me-1 text-info" /> No
            warranties</BCardTitle
          >
          <p class="text-muted">
            This Website is provided “as is,” with all faults, and Themesbrand
          ...
          <BCardTitle title-tag="h6" class="mb-3"
            ><i class="bi bi-circle-square align-baseline me-1 text-info" />
            Governing Law & Jurisdiction</BCardTitle
          >
          <p class="text-muted">
          ...
          <div class="d-flex justify-content-end gap-2">
            ...
            <BButton variant="outline-danger"
              ><i class="ri-close-line align-bottom me-1" /> Decline</BButton
            >
          </div>
        </BCardBody>
      </BCard>
