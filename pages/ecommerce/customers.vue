...
<template>
        ...
        <BCardBody>
          <div class="d-flex align-items-center flex-wrap gap-3">
            <div class="flex-grow-1">
              <BCardTitle title-tag="h3" class="mb-0"
                >Customers List</BCardTitle
              >
            </div>
            <div>
              <div class="d-flex flex-wrap gap-2">
                ...
                <BButton type="button" variant="secondary"
                  ><i class="ph-cloud-arrow-down align-middle me-1" />
                  Import</BButton
                >
                <BButton type="button" variant="subtle-info"
                  ><i class="ph-cloud-arrow-up align-middle me-1" />
                  Export</BButton
                >
              </div>
            </div>
  ...
  <BRow id="customer-list">
    <BCol xxl="8">
      ...
      <BCard no-body>
        <BCardBody>
                  ...
                  <td class="customer">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0 me-2">
                        <div>
                          <img
                            class="avatar-xs rounded-circle customer-image-elem"
                            alt=""
                            :src="data.img"
                          />
                        </div>
                      ...
                      <div class="flex-grow-1">
                        <h5 class="fs-base mb-0">
                          <BLink href="#" class="text-reset customer-name-elem"
                            >{{ data.name }}
                          </BLink>
                        </h5>
                      </div>
          ...
          <BRow
            class="align-items-center mt-4 pt-3 justify-content-between text-center text-sm-start"
    ...
    <BCol xxl="4">
      <BCard no-body id="overview-card">
        <BCardBody>
          <div class="d-flex gap-3 align-items-center flex-wrap">
            ...
            <div class="flex-grow-1">
              ...
              <p class="text-muted mb-0">
                <BLink href="#!" class="overview-nick-name"
                  >@{{
                    overviewDetails.name
                      .split(" ")
                      .slice(-1)
                      .join("")
                      .toLowerCase() || "@mosciski"
                  }}</BLink
                >
              </p>
            </div>
            <div class="flex-shrink-0">
              <BButton
                ...
                class="custom-toggle active me-1"
                data-bs-toggle="button"
              >
                <span class="icon-on"
                  ><i class="ri-add-line align-bottom me-1" /> Follow</span
                >
                <span class="icon-off"
              ...
              <BButton variant="subtle-danger" class="btn-icon"
                ><i class="ph-trash"></i
              ></BButton>
            </div>
          </div>
          <ul class="d-flex align-items-center gap-2 list-unstyled mt-4">
            <li>Social Media:</li>
            <li>
              <BLink href="#!" class="btn btn-subtle-success btn-icon btn-sm"
                ><i class="bi bi-whatsapp"></i
              ></BLink>
            </li>
            <li>
              <BLink href="#!" class="btn btn-subtle-primary btn-icon btn-sm"
                ><i class="bi bi-facebook"></i
              ></BLink>
            </li>
            <li>
              <BLink href="#!" class="btn btn-subtle-secondary btn-icon btn-sm"
                ...
                <tr>
                  ...
                  <td class="overview-status">
                    <span
                      ...
                      v-if="overviewDetails.status == 'Active'"
                      >{{ overviewDetails.status }}</span
                    >
                    <span
                      class="badge bg-danger-subtle text-danger"
                      v-if="overviewDetails.status == 'Block'"
                      >{{ overviewDetails.status }}</span
                    >
                    <span
              ...
              <div class="p-2 border border-dashed">
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="flex-grow-1">
                    ...
                    >
                      <li><i class="ph-star align-baseline" /> 487</li>
                      <li><i class="ph-shopping-cart align-baseline" /> 936</li>
                    </ul>
                  </div>
                  <div class="text-end">
                  ...
                  <div class="flex-shrink-0">
                    <BButton variant="secondary" size="sm" class="btn-icon"
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <ul
                      class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted"
                    >
                      <li><i class="ph-star align-baseline" /> 452</li>
                      <li>
                        <i class="ph-shopping-cart align-baseline" /> 1420
                      </li>
                    </ul>
                  </div>
                  <div class="text-end">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <ul
                      class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted"
                    >
                      <li><i class="ph-star align-baseline" /> 562</li>
                      <li>
                        <i class="ph-shopping-cart align-baseline" /> 1348
                      </li>
                    </ul>
                  </div>
                  <div class="text-end">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <ul
                      class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted"
                    >
                      <li><i class="ph-star align-baseline" /> 644</li>
                      <li>
                        <i class="ph-shopping-cart align-baseline" /> 1540
                      </li>
                    </ul>
                  </div>
                  <div class="text-end">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <ul
                      class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted"
                    >
                      <li><i class="ph-star align-baseline" /> 841</li>
                      <li><i class="ph-shopping-cart align-baseline" /> 985</li>
                    </ul>
                  </div>
                  <div class="text-end">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <ul
                      class="hstack list-unstyled gap-2 mb-0 fs-sm fw-medium text-muted"
                    >
                      <li><i class="ph-star align-baseline" /> 763</li>
                      <li><i class="ph-shopping-cart align-baseline" /> 763</li>
                    </ul>
                  </div>
                  <div class="text-end">
  ...
  <BModal
    ...
    :title="dataEdit ? 'Edit Customer' : 'Add Customer'"
    id="customerModal"
    centered
  >
    <BForm
    ...
    >
      ...
      <div class="mb-3">
        ...
        <flat-pickr
          v-model="event.create_date"
          :config="joinDateConfig"
          class="form-control"
      ...
      <div>
        <div class="hstack gap-2 justify-content-end">
          <BButton type="button" variant="light" @click="customerModal = false"
            >Close</BButton
          >
          <BButton type="submit" variant="success" id="add-btn">{{
            dataEdit ? "update" : "Add Customers"
          }}</BButton>
        </div>
      </div>
    </BForm>
