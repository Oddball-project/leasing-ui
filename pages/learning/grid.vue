  ...
  methods: {
    ...
    handleSubmit() {
      if (this.dataEdit) {
        ...
        if (
          this.submitted &&
          this.event.cardTitle &&
          this.event.course &&
          this.event.username &&
          this.event.lessons &&
          this.event.students &&
          this.event.courseDuration &&
          this.event.fees &&
          this.event.status
        ) {
          this.coursesGrid = this.coursesGrid.map((item) =>
          ...
          <BRow class="align-items-center gy-3">
            <BCol lg="3" class="order-last order-md-first me-auto">
              <div class="search-box">
                <input
                  ...
                  placeholder="Search for course, title or something..."
                  v-model="searchQuery"
                />
            ...
            <BCol lg="auto" class="text-end">
              <div class="d-flex gap-2">
                ...
                <nuxt-link
                  to="/learning/grid"
                  class="active btn btn-subtle-primary btn-icon ms-auto"
      ...
      <BCard no-body class="overflow-hidden">
        <BCardBody
          :class="
            ...
            ' text-center learning-widgets d-flex align-items-center justify-content-center'
          "
        >
        ...
        <BCardBody>
          ...
          <h6 class="text-truncate fs-md text-capitalize">
          ...
          >
            <li>
              <p class="text-muted mb-0">
                <i class="bi bi-clock align-baseline text-secondary me-1"></i
                >{{ data.courseDuration }}
              </p>
            </li>
            <li>
              <p class="text-muted mb-0">
                <i class="ph ph-student align-middle text-secondary me-1" />
                {{ data.students }}
              </p>
            </li>
            <li>
              <p class="text-muted mb-0">
                <i
                  class="ph ph-graduation-cap align-middle text-secondary me-1"
                />
        ...
        <BCardBody class="border-top hstack align-items-center gap-2">
          <div
            class="d-flex align-items-center gap-2 flex-grow-1 position-relative"
          >
            <div class="flex-shrink-0">
              <img
                :src="data.userImg"
          ...
          >
            ...
            <div>
              <nuxt-link class="dropdown-item" to="/learning/overview"
                ><i class="bi bi-eye align-baseline me-1" /> Overview</nuxt-link
              >
              ...
              <BLink
                ...
                ><i class="bi bi-trash3 align-baseline me-1" /> Delete</BLink
              >
            </div>
          </BDropdown>
        </BCardBody>
  ...
  <BRow class="align-items-center mb-3" v-if="resultQuery.length >= 1">
    <BCol cols="sm">
      <div class="text-muted text-center text-sm-start">
        ...
        <span class="fw-semibold">{{ coursesGrid.length }}</span> Results
      </div>
    </BCol>
    ...
    >
      ...
      <div class="mb-3">
        ...
        <input
          ...
          v-model="event.cardTitle"
          :class="{ 'is-invalid': submitted && !event.cardTitle }"
        />
      </div>
