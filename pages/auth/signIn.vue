                  ...
                  <BCardBody class="p-sm-5 m-lg-4">
                    ...
                    <div class="p-2 mt-5">
                      <form action="/">
                        ...
                        <div class="mb-3">
                          <div class="float-end">
                            <nuxt-link to="/auth/pass-reset" class="text-muted"
                        ...
                        <div class="mt-4 pt-2 text-center">
                          ...
                          <div class="pt-2 hstack gap-2 justify-content-center">
                            <BButton variant="subtle-primary" class="btn-icon"
                              ><i class="ri-facebook-fill fs-lg"
                            /></BButton>
                            <BButton variant="subtle-danger" class="btn-icon"
                              ><i class="ri-google-fill fs-lg"
                            /></BButton>
                            <BButton variant="subtle-dark" class="btn-icon"
                              ><i class="ri-github-fill fs-lg"
                            /></BButton>
                            <BButton variant="subtle-info" class="btn-icon"
                              ><i class="ri-twitter-fill fs-lg"
                            /></BButton>
                          </div>
                        </div>
                      </form>
