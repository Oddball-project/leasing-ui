...
import { sellersChart } from "~/components/eCommerce/chartsData";
import { sellers } from "@/common/data";
import DropZone from "@/common/dropZone.vue";
import { ref, watch, reactive } from "vue";
import sellerChart from "~/components/eCommerce/sellers/sellerChart.vue";
...
<template>
      ...
      <BCard no-body>
        <BCardBody>
          ...
          <div class="text-center mt-4">
            <nuxt-link to="/ecommerce/seller-overview">
              <h5>{{ data.name }}</h5>
            </nuxt-link>
        ...
        <BRow class="g-0 text-center">
          <BCol xxl="4" lg="6" md="4">
            <BCardBody
              class="px-3 border-top border-bottom border-end border-dashed"
            >
          ...
          <BCol xxl="4" lg="6" md="4">
            <BCardBody
              class="h-100 px-3 border-top border-bottom border-end border-dashed"
            >
              <sellerChart :color="data.chartColor" />
            </BCardBody>
          </BCol>
          <BCol xxl="4" lg="6" md="4">
            <BCardBody class="px-3 border-top border-bottom border-dashed">
              <h5 class="mb-1">{{ data.revenue }}</h5>
              <p class="text-muted text-truncate mb-0">Revenue</p>
            </BCardBody>
          </BCol>
        </BRow>
        <BCardBody class="hstack gap-2">
          <nuxt-link
            to="/ecommerce/seller-overview"
            class="btn btn-subtle-secondary w-100"
  ...
  >
    <BCol cols="sm">
      <div class="text-muted">
        ...
        <span class="fw-semibold">{{ sellers.length }}</span> Results
      </div>
    </BCol>
  ...
  <BModal
    ...
    :title="dataEdit ? 'Edit Seller details' : 'Add Seller'"
    id="addAgencies"
    hide-footer
  ...
  >
    ...
    >
      <label class="form-label"
        >Seller Logo <span class="text-danger">*</span></label
      >
      <DropZone
      ...
      <div class="mb-3">
        <label for="seller-Name" class="form-label"
          >Seller Name <span class="text-danger">*</span></label
        >
        <input
          type="text"
          class="form-control"
      ...
      <div class="text-end">
        ...
        >
        <BButton type="submit" variant="primary" class="submit-btn">{{
          dataEdit ? "update" : "Add"
        }}</BButton>
      </div>
    </form>
