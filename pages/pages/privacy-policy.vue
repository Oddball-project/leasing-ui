    ...
    <BCol xxl="9">
      <BCard no-body class="overflow-hidden">
        <div class="bg-primary pb-0">
          <BCardBody class="text-center py-4">
            ...
            <p class="text-white text-opacity-75 mb-0">
              To learn more about Privacy at themesbrand please visit our
              <BLink href="#!" class="text-white text-decoration-underline"
                >Privacy Hub</BLink
              >.
            </p>
          </BCardBody>
          <BCardBody class="py-2 bg-white bg-opacity-10">
            <ul
              class="list-unstyled mb-0 text-white-75 hstack gap-2 justify-content-between"
            >
              <li>Our privacy policy hes been updated</li>
              <li>25, March 2023</li>
            </ul>
          </BCardBody>
        </div>
        <BCardBody>
          ...
          <p class="text-muted mb-2">
            Your privacy statement should be clear, direct, and easy to
            understand.
          </p>
          <p class="text-muted mb-2">
          ...
          <BCardTitle title-tag="h6" class="mb-3"
            ><i class="bi bi-circle-square align-baseline me-1 text-info"></i>
            How we use your information</BCardTitle
          >
          <p class="text-muted mb-2">
            Right to Privacy: Every individual has his own secrets, talks,
            planning etc. which they don not want to show, tell and discuss with
            others. So right to privacy plays a important role in the freedom
            and liberty of a person and if our fundamental right given under
          ...
          <p class="text-muted mb-2">
            The specific differences, however, are more complex, and there can
            certainly be areas of overlap between the two. Security refers to
            protection against the unauthorized access of data.
          </p>
          <p class="text-muted mb-2">
        ...
        <BCardBody>
          ...
          <p class="text-muted mb-2">
            ...
            decisions about it every single day. It gives us a space to be
            ourselves without judgement, allows us to think freely without
            discrimination, and is an important element of giving us control
          ...
          <div class="text-end">
            <BButton variant="secondary">I'm Understand</BButton>
          </div>
        </BCardBody>
      </BCard>
    </BCol>
