...
const chartCandlestickBasicColors = getChartColorsArray(
  '["--tb-success", "--tb-danger"]'
);
...
const chartCandlestickComboColors = getChartColorsArray(
  '["--tb-info", "--tb-danger"]'
);
...
// Category X-axis
const chartCandlestickCategoryColors = getChartColorsArray(
  '["--tb-success", "--tb-danger"]'
);
...
// Category X-axis
const chartCandlestickLineColors = getChartColorsArray(
  '["--tb-success", "--tb-danger", "--tb-info", "--tb-warning"]'
);
