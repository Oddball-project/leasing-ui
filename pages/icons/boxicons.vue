      ...
      <BCard no-body>
        <BCardHeader>
          ...
          <p class="text-muted mb-0">
            Use <code>&lt;i class="bx bx-**">&lt;/i></code> class.
          </p>
        </BCardHeader>
        <BCardBody>
          <h5>Regular</h5>
          <BRow class="icon-demo-content">
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-circle-three-quarter"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-collapse-horizontal"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6"> <i class="bx bx-x"></i> bx bx-x </BCol>
            <BCol xl="3" lg="4" sm="6">
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-calendar-exclamation"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-chevron-down-circle"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-chevron-left-circle"></i> bx
              bx-chevron-left-circle
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-chevron-right-circle"></i> bx
              bx-chevron-right-circle
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-chevron-down-square"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-chevron-left-square"></i> bx
              bx-chevron-left-square
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-chevron-right-square"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-rounded-check"></i> bx
              bx-message-rounded-check
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-rounded-error"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-rounded-minus"></i> bx
              bx-message-rounded-minus
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-rounded-edit"></i> bx
              bx-message-rounded-edit
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-rounded-add"></i> bx
              bx-message-rounded-add
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-rounded-detail"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-square-check"></i> bx
              bx-message-square-check
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-square-error"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-square-minus"></i> bx
              bx-message-square-minus
            </BCol>
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-square-edit"></i> bx
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bx-message-square-detail"></i> bx
          ...
          <p class="text-muted mb-0">
            Use class <code>&lt;i class="bx bxs-**">&lt;/i></code>
          </p>
          ...
          <BRow class="icon-demo-content">
            ...
            <BCol xl="3" lg="4" sm="6">
              <i class="bx bxs-circle-three-quarter"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-calendar-exclamation"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-caret-right-square"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-chevron-down-circle"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-chevron-left-circle"></i> bx
              bxs-chevron-left-circle
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-chevron-right-circle"></i> bx
              bxs-chevron-right-circle
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-chevron-down-square"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-chevron-left-square"></i> bx
              bxs-chevron-left-square
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-chevron-right-square"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-alt-detail"></i> bx
              bxs-message-alt-detail
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-rounded-check"></i> bx
              bxs-message-rounded-check
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-rounded-error"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-rounded-minus"></i> bx
              bxs-message-rounded-minus
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-rounded-edit"></i> bx
              bxs-message-rounded-edit
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-rounded-add"></i> bx
              bxs-message-rounded-add
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-rounded-detail"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-square-check"></i> bx
              bxs-message-square-check
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-square-error"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-square-minus"></i> bx
              bxs-message-square-minus
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-square-edit"></i> bx
              bxs-message-square-edit
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-square-add"></i> bx
              bxs-message-square-add
            </BCol>
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-message-square-detail"></i> bx
            ...
            <BCol sm="6" lg="4" xl="3">
              <i class="bx bxs-bookmark-alt-minus"></i> bx
          ...
          <p class="text-muted mb-0">
            Use class <code>&lt;i class="bx bl-**">&lt;/i></code>
          </p>
          <BRow class="icon-demo-content">
            <BCol sm="6" lg="4" xl="3">
