  ...
  methods: {
    handleUpdate() {
      this.totalInstructorsChart = {
        ...this.totalInstructorsChart,
        chartOptions: {
          ...this.totalInstructorsChart.chartOptions,
      ...
      this.instructorActivityChart = {
        ...this.instructorActivityChart,
        chartOptions: {
          ...this.instructorActivityChart.chartOptions,
    ...
    handleSubmit() {
      if (this.dataEdit) {
        ...
        if (
          ...
          this.event.name &&
          this.event.email &&
          this.event.total_course &&
          this.event.experience &&
          this.event.students &&
          this.event.contact &&
          this.event.status
        ) {
          this.instructorsList = this.instructorsList.map((item) =>
      ...
      <BCol xl="2" sm="6">
        <BCard no-body class="card-height-100">
          <BCardBody class="text-center">
            ...
            />
            <BCardTitle title-tag="h5" class="mt-3"
              >Total Instructors</BCardTitle
            >
            <p class="text-muted mb-0">
              <span class="text-success"
                ><i class="ph ph-trend-up align-middle me-1" /> 07.78%</span
              >
              than last week
            </p>
          </BCardBody>
          ...
          <BCardBody class="text-center">
            ...
            <p class="text-muted mb-0">
              <span class="text-danger"
                ><i class="ph ph-trend-down align-middle me-1" /> 01.39%</span
              >
              than last week
            </p>
          </BCardBody>
      ...
      <BCol xl="8">
        <BCard no-body>
          <BCardHeader class="d-flex align-items-center">
            <div class="h6 card-title flex-grow-1 mb-0">
              Instructor Activity
            </div>
            <div class="flex-shrink-0">
              <BButton size="sm" variant="subtle-secondary" class="me-1">
                ALL
              </BButton>
              <BButton size="sm" variant="secondary" class="me-1"> 1M </BButton>
              <BButton size="sm" variant="subtle-secondary" class="me-1">
                6M
              </BButton>
              <BButton size="sm" variant="subtle-secondary"> 1Y </BButton>
            </div>
          </BCardHeader>
            ...
            <div class="table-responsive table-card">
              ...
              <div class="noresult" v-if="resultQuery.length < 1">
                <div class="text-center py-4">
                  ...
                  <p class="text-muted mb-0">
                    We've searched more than 164+ instructors We did not find
                    any instructors for you search.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <BCol cols="sm">
                <div class="text-muted text-center text-sm-start">
                  ...
                  <span class="fw-semibold">{{ instructorsList.length }}</span>
                  Results
                </div>
              </BCol>
    ...
    >
        ...
        <BCol lg="6">
          <div class="mb-3">
            ...
            <input
              ...
              v-model="event.total_course"
              :class="{ 'is-invalid': submitted && !event.total_course }"
            />
          </div>
        </BCol>
        <BCol lg="6">
      ...
      <div>
        <div class="hstack gap-2 justify-content-end">
          <BButton variant="ghost-danger" @click="instructorsModal = false"
