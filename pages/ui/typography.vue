...
<template>
  ...
  <BRow>
    <BCol xxl="6">
      ...
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Headings</BCardTitle>
        </BCardHeader>
    ...
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Display Headings</BCardTitle>
        </BCardHeader>
  ...
  <BRow>
    <BCol lg="12">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Blockquotes</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>&lt;blockquote class="blockquote"&gt;</code> class for
  ...
  <BRow>
    <BCol lg="12">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Blockquote Background Color</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted text-muted">
            Use <code>blockquote-</code> class with the below-mentioned color
  ...
  <BRow>
    <BCol lg="12">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Blockquote Border Color</BCardTitle>
        </BCardHeader>
        <BCardBody>
          <p class="text-muted text-muted">
            Use <code>blockquote-outline</code> class to set blockquote border
            color.
          </p>
          <BRow class="gy-4">
            <BCol xl="4" md="6">
  ...
  <BRow>
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Inline Text Elements</BCardTitle>
        </BCardHeader>
    ...
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Unstyled List</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>list-unstyled</code> class Remove the default list-style
...
&lt;/ul&gt;</code></pre>
      ...
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Inline List</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>list-inline</code> and <code>list-inline-item</code> class
            combination to remove a list’s bullets and apply some light margin.
          </p>
  ...
  <BRow>
    <BCol xl="12">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Description List Alignment</BCardTitle>
        </BCardHeader>
  ...
  <BRow>
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Text Wrapping and Overflow</BCardTitle>
        </BCardHeader>
    ...
    &lt;/div&gt;</code></pre>
      ...
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Word Break</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <div>
            <p class="text-muted">
              Use <code>text-break</code> class to prevent long strings of text
...
&lt;p class=&quot;text-break mb-0&quot;&gt;mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm&lt;/p&gt;</code></pre>
    ...
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Font size</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>fs-1</code>, <code>fs-2</code>, <code>fs-3</code>,
            <code>fs-4</code>, <code>fs-5</code>, or <code>fs-6</code>, class to
  ...
  <BRow>
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Font weight and italics</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>fst-</code>with modifier class to change font-style and
            Use <code>fw-</code>with modifier class to change font-weight.
          </p>
    ...
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Line height</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>lh-</code> with modifier class to change the line height
            of an element.
          </p>
          <div>
            <p class="lh-1">
              This is a long paragraph written to show how the line-height of an
              element is affected by our utilities. Classes are applied to the
              element itself or sometimes the parent element. These classes can
              be customized as needed with our utility API.
            </p>
            <p class="lh-sm">
              This is a long paragraph written to show how the line-height of an
              element is affected by our utilities. Classes are applied to the
            ...
            <p class="lh-base">
              This is a long paragraph written to show how the line-height of an
              element is affected by our utilities. Classes are applied to the
              element itself or sometimes the parent element.
            </p>
            <p class="lh-lg mb-0">
              This is a long paragraph written to show how the line-height of an
              element is affected by our utilities. Classes are applied to the
  ...
  <BRow>
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Text Transform</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>text-lowercase</code>, <code>text-uppercase</code>, or
    ...
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Text Decoration</BCardTitle>
        </BCardHeader>
        ...
        <BCardBody>
          ...
          <div>
            ...
            <BLink href="#" class="text-decoration-none"
              >This link has its text decoration removed</BLink
            >
          </div>
        </BCardBody>
        <BCardBody class="bg-light border-bottom border-top bg-opacity-25">
    ...
    <code>&lt;BLink href=&quot;#&quot; class=&quot;text-decoration-none&quot;&gt;This link has its text decoration removed&lt;/BLink&gt;</code></pre>
        </BCardBody>
      </BCard>
    </BCol>
  </BRow>
  ...
  <BRow>
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Text Truncation</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>text-truncate</code> class to truncate the text with an
...
&lt;/span&gt;</code></pre>
    ...
    <BCol xxl="6">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Visibility</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>visible</code> or <code>invisible</code> class to show or
            to hide elements respectively.
          </p>
  ...
  <BRow>
    <BCol lg="12">
      <BCard no-body>
        <BCardHeader>
          <BCardTitle class="mb-0">Clearfix</BCardTitle>
        </BCardHeader>

        <BCardBody>
          <p class="text-muted">
            Use <code>clearfix</code> class to clear/set floated content within
            a container.
          </p>
          <div class="bg-light clearfix p-3">
            <BButton type="button" variant="secondary" class="float-start"
              >Example Button floated left</BButton
            >
            <BButton type="button" variant="success" class="float-end"
              >Example Button floated right</BButton
            >
          </div>
        </BCardBody>
        <BCardBody class="bg-light border-bottom border-top bg-opacity-25">
        ...
        &lt;BButton type=&quot;button&quot; variant=&quot;secondary&quot; class=&quot;float-start&quot;&gt;Example Button floated left&lt;/BButton&gt;
        &lt;BButton type=&quot;button&quot; variant=&quot;secondary&quot; class=&quot;float-end&quot;&gt;Example Button floated right&lt;/BButton&gt;
&lt;/div&gt;</code></pre>
        </BCardBody>
      </BCard>
    </BCol>
