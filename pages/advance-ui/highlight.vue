  ...
  <BRow>
    <BCol lg="12">
      <BCard no-body>
        ...
        <BCardBody>
          <p class="text-muted mb-0">
            CSS highlight is used to mark or highlight text that is of property,
            relevance, or special interest to a CSS document. Here is the
            example shown below.
          </p>
        </BCardBody>
        <BCardBody
          class="bg-light border-bottom border-top bg-opacity-25 d-flex align-items-center"
        >
          <h5 class="flex-grow-1 fs-xs text-muted mb-0">CSS Preview</h5>
          <div class="flex-shrink-0">
            <BLink href="#!"><i class="bi bi-clipboard"></i></BLink>
          </div>
        </BCardBody>
        <BCardBody>
