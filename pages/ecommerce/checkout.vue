...
<template>
  ...
  <BRow>
      ...
      <BRow>
        <BCol lg="12">
          ...
          <BAlert
            ...
            dismissible
          >
            <i class="bi bi-cart3 align-baseline me-1" /> Minimum order must be
            <b>$1800</b>. You need to add more products with total cost of
            <b>$300</b>
          </BAlert>
          <BCard no-body>
            <BCardHeader>
              <BCardTitle title-tag="h6" class="mb-0"
                >Personal Information</BCardTitle
              >
            </BCardHeader>
            <BCardBody>
              <form action="#!">
          ...
          <BCard no-body>
            <BCardHeader class="d-flex align-items-center">
              <BCardTitle title-tag="h6" class="flex-grow-1 mb-0"
                >Shipping Information</BCardTitle
              >
            </BCardHeader>
            <BCardBody>
              ...
              <BRow class="gy-3">
                <BCol lg="4" sm="6">
                  <div class="form-check card-radio rounded-bottom-0">
                    ...
                    <label class="form-check-label" for="shippingAddress01">
                      <span
                        class="mb-3 fw-semibold d-block text-muted text-uppercase"
                        >Home Address</span
                      >

                      <span class="fs-md mb-2 d-block fw-medium"
                        >Kiara Corkery</span
                      >
                      <span class="text-muted fw-normal text-wrap mb-1 d-block"
                        >912 Park Ave, Ketchikan, Alaska 99901, USA</span
                      >
                      <span class="text-muted fw-normal d-block"
                        >Mo. (907) 826-3317</span
                      >
                    </label>
                  </div>
                  <div
                    class="d-flex flex-wrap p-2 py-1 rounded-bottom border mt-n1"
                  >
                    <div>
                      <BLink
                        href="javascript: void(0);"
                        class="d-block text-body p-1 px-2"
                        @click="addAddressModal = !addAddressModal"
                        ><i
                    ...
                    <div>
                      <BLink
                        href="javascript: void(0);"
                        class="d-block text-body p-1 px-2"
                        @click="removeItemModal = !removeItemModal"
                        ><i
                ...
                <BCol lg="4" sm="6">
                  <div class="form-check card-radio rounded-bottom-0">
                    ...
                    <label class="form-check-label" for="shippingAddress02">
                      ...
                      >
                      <span class="text-muted fw-normal text-wrap mb-1 d-block"
                        >2566 Hc 1, Glennallen, Alaska 99588, USA</span
                      >
                      <span class="text-muted fw-normal d-block"
                        >Mo. (907) 225-9273</span
                      >
                    </label>
                  </div>
                  <div
                ...
                <BCol lg="4" sm="6">
                  ...
                  >
                    ...
                    >
                      <div>
                        <div class="fs-4xl mb-2">
                          <i class="bi bi-plus-circle-dotted" />
                        </div>
                        <div
                          class="fw-medium fs-md text-primary-emphasis stretched-link"
                          @click="addAddressModal = !addAddressModal"
                        >
                          Add Address
                        </div>
                    ...
                    <div class="form-check card-radio">
                      ...
                      >
                        <span class="avatar-sm">
                          <span
                            class="avatar-title bg-light rounded text-body fs-4"
                          >
                            <i class="bi bi-truck" />
                          </span>
                        </span>
                        <span class="flex-grow-1">
                          <span class="fs-md fw-medium mb-1 text-wrap d-block"
                            >Free Delivery</span
                          >
                        ...
                        <span
                          class="fs-3xl float-end mt-2 text-wrap d-block fw-semibold"
                          >Free</span
                        >
                      </label>
                    </div>
        ...
        <BCol lg="12">
          <BCard no-body>
            <BCardHeader class="d-flex align-items-center">
              <BCardTitle title-tag="h6" class="flex-grow-1 mb-0"
                >Payment Information</BCardTitle
              >
              <BButton
                variant="subtle-info"
                class="flex-shrink-0"
                @click="addCardModal = !addCardModal"
              ...
              <BRow>
                <BCol lg="4">
                  <div class="form-check card-radio">
                    ...
                    />
                    <label
                      class="form-check-label bg-primary p-4"
                      for="debitCart01"
                    >
                      <i
                        class="bi bi-cash-coin position-absolute top-0 end-0 display-1 text-white"
                        style="opacity: 0.06"
                      />
                      <span class="d-flex align-items-center mb-4 pb-4">
                        <img
                          ...
                          height="20"
                        />
                        <i class="ph-wifi-high ms-auto fs-4 text-white-75" />
                      </span>
                      <span class="fs-3xl text-white fw-medium mb-2 d-block"
                        >9873 6548 9871 0123</span
                      >
                      <span class="d-flex align-items-center">
                        <span class="fs-xs text-white-75 d-block"
                          >Ophelia Steuber</span
                        >
                        <span class="fs-xxs text-white-75 d-block ms-auto"
                          >Valid <b>32</b></span
                        >
                      </span>
                    </label>
                ...
                <BCol lg="4">
                  <div class="form-check card-radio">
                    ...
                    />
                    <label
                      class="form-check-label bg-secondary p-4"
                      for="debitCart02"
                    >
                      <i
                        class="bi bi-coin position-absolute top-0 end-0 display-1 text-white"
                        style="opacity: 0.06"
                      />
                      <span class="d-flex align-items-center mb-4 pb-4">
                        <img
    ...
    <BCol xxl="4">
      <BRow>
              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  <BCardTitle title-tag="h5" class="mb-0"
                    >Order Summary</BCardTitle
                  >
                </div>
                <div class="flex-shrink-0">
                  <span class="badge bg-success-subtle text-success"
                    >Valid Time: 5:00</span
                  >
                </div>
              </div>
            </BCardHeader>
                ...
                <table class="table table-borderless align-middle mb-0">
                  ...
                  <tbody>
                      ...
                      <td>
                        <h5 class="fs-md">
                          <nuxt-link
                            to="/ecommerce/product-details"
                            class="text-dark"
                            >Fossil gen 5E smart watch</nuxt-link
                          >
                        </h5>
                      ...
                      <td>
                        <h5 class="fs-md">
                          <nuxt-link
                            to="/ecommerce/product-details"
                            class="text-dark"
                            >Olive Printed Men Round Neck</nuxt-link
                          >
                        </h5>
                      ...
                      <td>
                        <h5 class="fs-md">
                          <nuxt-link
                            to="/ecommerce/product-details"
                            class="text-dark"
                            >Flip-Flops and House Slippers</nuxt-link
                          >
                        </h5>
                    ...
                    <tr class="border-top border-dashed">
                      ...
                      <td class="text-end">
                        <span class="fw-semibold"> $2,050.18 </span>
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <BCol lg="12">
          <BCard no-body>
            <BCardHeader>
              <BCardTitle title-tag="h5" class="mb-0"
                >Additional Service</BCardTitle
              >
            </BCardHeader>
            <BCardBody class="d-flex form-check form-switch gap-3">
              <div class="flex-grow-1">
                <label
                  for="additionalServices"
                  class="form-check-label fs-md fw-semibold mb-2"
              ...
              <div class="flex-shrink-0 fw-medium">$25</div>
              <div class="flex-shrink-0">
            ...
            <BCardBody class="d-flex form-check form-switch gap-3 border-top">
              <div class="flex-grow-1">
                <label
                  for="additionalServices2"
                  class="form-check-label fs-md fw-semibold mb-2"
                  >Care + Package</label
                >
                <p class="text-muted mb-0">
              ...
              <div class="flex-shrink-0 fw-medium">$10</div>
              <div class="flex-shrink-0">
                <div class="form-check form-switch">
                  <input
                    class="form-check-input"
      ...
      <div class="text-end">
        <BButton
          type="button"
          @click="confirmOrderModal = !confirmOrderModal"
          variant="primary"
          class="me-1"
          >Confirm Order</BButton
        >
        <nuxt-link to="/ecommerce/products-grid" class="btn btn-secondary"
  ...
  >
    ...
    <div class="text-end">
      <BButton
        ...
        ><i class="bi bi-x-lg align-baseline me-1" /> Close</BButton
      >
      <BButton type="button" variant="primary" @click="addAddressModal = false"
        >Add Address</BButton
      >
    </div>
  </BModal>
  ...
  >
    <div class="mt-2 text-center">
      <i class="ph-trash display-5 text-danger" />
      <div class="mt-4 pt-2 mx-4 mx-sm-5">
        <h4>Are you sure ?</h4>
        <p class="text-muted mx-4 mb-0">
