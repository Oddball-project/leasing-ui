  ...
  <BRow class="justify-content-center">
    <BCol xxl="9">
      <div class="hstack gap-2 justify-content-end d-print-none mb-4">
        <BLink href="javascript:window.print()" class="btn btn-success"
          ><i class="ri-printer-line align-bottom me-1"></i> Print</BLink
        >
        <BButton type="button" id="download-button" variant="primary"
      ...
      <BCard no-body class="overflow-hidden" id="invoice">
        ...
        <BCardBody class="z-1 position-relative">
          ...
          <div class="table-responsive mt-4">
            <BTableSimple
              class="table-borderless text-center table-nowrap align-middle mb-0"
            >
              <BThead>
                <BTr class="table-light">
                  ...
                  <BTh scope="col">Quantity</BTh>
                  <BTh scope="col" class="text-end">Amount</BTh>
                </BTr>
              </BThead>
              <BTbody id="products-list">
                <BTr>
                ...
                <BTr>
                  ...
                  <BTd>$250.00</BTd>
                  <BTd>06</BTd>
                  <BTd class="text-end">$1,500.00</BTd>
                </BTr>
                <BTr>
          ...
          >
            <BTableSimple
              class="table-borderless table-nowrap align-middle mb-0 ms-auto"
              style="width: 250px"
            >
              <BTbody>
                <BTr>
                  <BTd>Sub Total</BTd>
                  <BTd class="text-end">$2,272.95</BTd>
                </BTr>
                <BTr>
                  <BTd>Estimated Tax <small class="text-muted">(18%)</small></BTd>
                ...
                <BTr>
                  ...
                  <BTd class="text-end">$65.00</BTd>
                </BTr>
                <BTr class="border-top border-top-dashed fs-15">
                  <BTh scope="row">Total Amount</BTh>
                  <BTh class="text-end">$2,050.20</BTh>
                </BTr>
              </BTbody>
            </BTableSimple>
          </div>
          <div class="mt-3">
            ...
            <p class="text-muted mb-1">
              Payment Method:
              <span class="fw-medium" id="payment-method">Mastercard</span>
            </p>
            <p class="text-muted mb-1">
              Card Holder:
              <span class="fw-medium" id="card-holder-name"
                >Jennifer Mayert</span
              >
            </p>
            <p class="text-muted mb-1">
              Card Number:
              <span class="fw-medium" id="card-number">xxx xxxx xxxx 1234</span>
            </p>
            <p class="text-muted mb-0">
              Total Amount: <span class="fw-medium">$</span
              ><span id="card-total-amount">2,050.18</span>
            </p>
          </div>
          <div class="mt-4 mb-4">
            <BAlert variant="danger" class="mb-0" :model-value="true">
