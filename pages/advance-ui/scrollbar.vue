  ...
  <BRow>
    ...
    <BCol xl="6">
      <BCard no-body>
        ...
        <BCardBody>
          <p class="text-muted">
            Use <code>data-simplebar-auto-hide="false"</code> attribute and add
  ...
  <BRow>
    <BCol xl="6">
      <BCard no-body>
        ...
        <BCardBody>
          <p class="text-muted">
            Use <code>data-simplebar-direction="rtl"</code> attribute and add
      ...
      <BRow>
              ...
              <div class="mx-n3">
                ...
                >
                  ...
                  >
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 text-muted">
                        <p class="m-0">
                          Your
                          <span class="fw-semibold text-dark">Elite</span>
                  ...
                  >
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 text-muted">
                        <p class="m-0">
                          You have received
                          <span class="fw-semibold text-success">20</span> new
                  ...
                  <div class="text-center my-2">
                    <BLink href="#" class="text-success"
                      ><i
                        class="mdi mdi-loading mdi-spin fs-3xl align-middle me-2"
                      ></i>
                      Load more
                    </BLink>
                  </div>
        ...
        <BCol xl="4" lg="6">
          <BCard no-body>
            ...
            <BCardBody>
              <p class="text-muted">
                Use <code>data-simplebar-track="secondary"</code> attribute to
                set secondary color simplebar track.
              </p>
                    ...
                    <BLink href="#" class="list-group-item text-muted py-3">
                      <div class="d-flex align-items-start">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                          <h5 class="text-truncate fs-md mb-1">
                            Michael Johnston
                          </h5>
        ...
        <BCol xl="4" lg="6">
          <BCard no-body>
            ...
            <BCardBody>
              <p class="text-muted">
                Use <code>data-simplebar-track="success"</code> attribute to set
                success color simplebar track.
              </p>
        ...
        <BCol xl="4" lg="6">
          <BCard no-body>
            ...
            <BCardBody>
              <p class="text-muted">
                Use <code>data-simplebar-track="info"</code> attribute to set
                info color simplebar track.
              </p>
        ...
        <BCol xl="4" lg="6">
          <BCard no-body>
            ...
            <BCardBody>
              <p class="text-muted">
                Use <code>data-simplebar-track="warning"</code> attribute to set
                warning color simplebar track.
              </p>
              ...
              <div class="mx-n3">
                ...
                >
                  <div class="d-flex align-items-center py-3">
                    ...
                    <div class="flex-shrink-0 ms-2">
                      <BButton type="button" size="sm" variant="outline-success"
        ...
        <BCol xl="4" lg="6">
          <BCard no-body>
            ...
            <BCardBody>
              <p class="text-muted">
                Use <code>data-simplebar-track="danger"</code> attribute to set
                danger color simplebar track.
              </p>
                ...
                >
                  <BLink href="#" class="d-flex align-items-center py-2">
                    ...
                    <div class="flex-shrink-0 align-self-start ms-2">
                      <div class="badge bg-warning-subtle text-warning fs-3xs">
                        Inprogress
                      </div>
                    </div>
                  </BLink>
                  ...
                  <BLink href="#" class="d-flex align-items-center py-2">
                    ...
                    <div class="flex-shrink-0 align-self-start ms-2">
                      <div class="badge bg-success-subtle text-success fs-3xs">
                        Completed
                      </div>
                    </div>
                  </BLink>
        ...
        <BCol xl="4" lg="6">
          <BCard no-body>
            ...
            <BCardBody>
              <p class="text-muted">
                Use <code>data-simplebar-track="dark"</code> attribute to set
                dark color simplebar track.
              </p>
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                      <div>
                        ...
                        <p class="text-muted mb-4">
                          Ut enim ad minima veniam, quis nostrum ullam corporis
                          suscipit consequatur nisi ut
                        </p>
                        <div class="d-flex align-items-start">
                          <div class="flex-grow-1">
