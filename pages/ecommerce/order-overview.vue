...
<template>
  ...
  <BRow>
    <BCol lg="12">
      <BCard>
        <BCadBody class="d-flex align-items-center flex-wrap gap-3">
          ...
          <div class="flex-shrink-0 text-end">
            <h6 class="fs-md mb-2">
              15 Feb, 2023
              <i class="bi bi-calendar4-event align-baseline ms-1"></i>
            </h6>
          ...
          <div class="flex-shrink-0">
            <nuxt-link to="/invoices/overview" class="btn btn-primary"
              ><i class="ph-download-simple align-middle me-1"></i>
              Invoice</nuxt-link
            >
          </div>
        </BCadBody>
  ...
  <BRow>
    <BCol xxl="3" md="6">
      <BCard class="border-bottom border-2 border-secondary">
        <BCadBody class="d-flex gap-3">
          <div class="flex-grow-1">
            <BCardTitle title-tag="h6" class="mb-3">Customer Info</BCardTitle>
    ...
    <BCol xxl="3" md="6">
      <BCard class="border-bottom border-2 border-primary">
        <BCadBody class="d-flex gap-3">
          <div class="flex-grow-1">
            <BCardTitle title-tag="h6" class="mb-3">Shipping Info</BCardTitle>
    ...
    <BCol xxl="3" md="6">
      <BCard class="border-bottom border-2 border-info">
        <BCadBody class="d-flex gap-3">
          <div class="flex-grow-1">
            <BCardTitle title-tag="h6" class="mb-3">Billing Info</BCardTitle>
            <p class="fw-medium fs-md mb-1">Bryana Watsica</p>
            <p class="text-muted mb-1">730 Madison Ave, Covington</p>
            <p class="text-muted mb-0">Kentucky, United States</p>
          </div>
    ...
    <BCol xxl="3" md="6">
      <BCard class="border-bottom border-2 border-light">
        <BCadBody class="d-flex gap-3">
          <div class="flex-grow-1">
            <BCardTitle title-tag="h6" class="mb-3">Payment Info</BCardTitle>
  ...
  <BRow>
    <BCol xxl="9">
      <BCard>
        <BCardHeader class="d-flex align-items-center px-0 pt-0 pb-2">
          <BCardTitle title-tag="h6" class="flex-grow-1"
            >Product Items</BCardTitle
          >
          <div class="flex-shrink-0">
            <BButton variant="danger" size="sm"
              ><i class="ph-x align-middle"></i> Cancel Order</BButton
            >
          </div>
        </BCardHeader>
        <BCadBody>
                  ...
                  <td>
                    <div class="product-item d-flex align-items-center gap-2">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="text-muted mb-0">
                          <BLink href="#!" class="text-reset">Fashion</BLink>
                        </p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="product-item d-flex align-items-center gap-2">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="text-muted mb-0">
                          <BLink href="#!" class="text-reset">Watch</BLink>
                        </p>
                      </div>
                    </div>
                  </td>
                      ...
                      <div class="flex-grow-1">
                        <h6 class="fs-md">
                          <nuxt-link
                            to="/ecommerce/product-details"
                            class="text-reset"
                            >Blive Printed Men Round Neck</nuxt-link
                          >
                        </h6>
                        <p class="text-muted mb-0">
                          <BLink href="#!" class="text-reset">Fashion</BLink>
                  ...
                  <td>
                    <div class="product-item d-flex align-items-center gap-2">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="text-muted mb-0">
                          <BLink href="#!" class="text-reset">Footwear</BLink>
                        </p>
                      </div>
                    </div>
                  </td>
    ...
    <BCol xxl="3">
      <BRow>
        <BCol xxl="12" lg="6">
          <BCard>
            <BCardTitle title-tag="h6" class="pb-2"
              >Total order amount</BCardTitle
            >
            <BCadBody>
          ...
          <BCard>
            <BCadBody>
              <div class="d-flex align-items-center">
                <BCardTitle title-tag="h5" class="flex-grow-1 pb-2"
                  >Logistics Details</BCardTitle
                >
                <div class="flex-shrink-0">
                  <BLink
                    href="#"
            ...
            <BCadBody class="border-top border-dashed">
              <div>
                <h6 class="text-muted float-end mb-0">ID: MFDS1400457854</h6>
                <h5 class="fs-lg clearfix">
                  <BLink href="#!" class="text-reset">Themesbrand</BLink>
                </h5>
      ...
      <BCard>
        <div class="d-flex align-items-center flex-wrap pb-3">
          <BCardTitle title-tag="h6" class="flex-grow-1 mb-0"
            >Order Status</BCardTitle
          >
          <div class="flex-shrink-0">
            <BButton size="sm" class="danger"
              ><i class="ph-x align-middle"></i> Cancel Order</BButton
            >
            <nuxt-link
        ...
        <BCadBody>
          <div class="progress progress-step-arrow progress-info mb-4">
            ...
            <BLink
              ...
              aria-valuemin="0"
              aria-valuemax="100"
              ><i class="ph-package align-middle me-1"></i> Packed</BLink
            >
            <BLink
              href="#"
          ...
          <div>
            <div class="ratio" style="height: 380px">
              <iframe
