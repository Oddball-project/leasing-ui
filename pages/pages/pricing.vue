...
<template>
  ...
  <BRow class="justify-content-center mt-4">
    <BCol lg="5">
      <div class="text-center mb-5">
        ...
        <p class="text-muted mb-4 fs-base">
  ...
  <BRow class="justify-content-center">
    <BCol xxl="9">
      <BRow>
        <BCol xxl="4" lg="6" class="g-3">
          <BCard no-body class="pricing-box">
            <BCardBody class="p-4">
              <div class="d-flex gap-3 align-items-center mb-4 pb-2">
                <div class="avatar-sm flex-shrink-0">
                  <div
                    class="avatar-title bg-success-subtle text-success fs-3 rounded"
                  >
                    <i class="ph ph-telegram-logo" />
                  </div>
                </div>
              ...
              <div class="mb-4">
                <h3 class="mb-0 me-2">
                  $29.99
                  <small class="fw-normal text-muted fs-xs">/Monthly</small>
                </h3>
              </div>
              ...
              <div class="mt-4">
                <ul class="ps-3 vstack gap-3">
                  ...
                  <li class="text-decoration-line-through text-muted">
                    In app messaging
                  </li>
                  <li class="text-decoration-line-through text-muted">
                    <b>5</b> FTP Login
              ...
              <div class="mt-4">
                <BButton variant="primary" class="w-100">Change Plan</BButton>
              </div>
            </BCardBody>
          </BCard>
        </BCol>
        ...
        <BCol xxl="4" lg="6" class="g-3">
          <BCard no-body class="pricing-box ribbon-box right">
            ...
            <BCardBody class="p-4">
              ...
              <div class="mt-4">
                <BButton variant="secondary" class="disabled w-100"
                  >Your Current Plan</BButton
                >
              </div>
            </BCardBody>
          </BCard>
    ...
    <BCol xxl="3" lg="6">
      <BCard no-body>
        <BCardBody class="p-4">
          ...
          <div class="mb-4">
            <h3 class="mb-0 me-2">
              $19.99 <small class="fs-xs text-muted fw-normal">/Monthly</small>
            </h3>
          </div>
          <div class="mt-4">
            <BButton variant="primary" class="w-100">Change Plan</BButton>
            ...
            <ul class="list-unstyled vstack gap-3 mb-0">
              <li>
                <div class="d-flex align-items-center">
                  <i class="bi bi-check-lg text-success me-2 align-middle" />
    ...
    <BCol xxl="3" lg="6">
      <BCard no-body class="ribbon-box right">
        ...
        <BCardBody class="p-4">
          ...
          <div class="mb-4">
            <h3 class="mb-0 me-2">
              $49.99 <small class="fs-xs text-muted fw-normal">/Monthly</small>
            </h3>
          </div>
          <div class="mt-4">
            <BButton variant="secondary" class="disabled w-100"
  ...
  <BRow>
    <BCol xxl="3" lg="6">
      <BCard
        no-body
        class="card-animate border-0 border-top border-2 border-success rounded-0 rounded-bottom"
      >
        <BCardBody class="m-2 p-4">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
              <h2 class="mb-0">
                $19 <small class="fs-sm text-muted">/Month</small>
              </h2>
            </div>
          </div>
            ...
            <li>
              <div class="d-flex">
                <div class="flex-shrink-0 text-success me-1">
                  <i class="ri-checkbox-circle-fill fs-base align-middle" />
                </div>
          ...
          <div class="mt-3 pt-2">
            <BLink href="#" class="btn btn-danger disabled w-100"
              >Your Current Plan</BLink
            >
          </div>
        </BCardBody>
      </BCard>
    ...
    <BCol xxl="3" lg="6">
      <BCard
        no-body
        class="card-animate border-0 border-top border-2 border-secondary rounded-0 rounded-bottom"
      >
        <BCardBody class="m-2 p-4">
          <div class="d-flex align-items-center mb-3">
            <div class="flex-grow-1">
            ...
            <div class="ms-auto">
              <h2 class="mb-0">
                $29 <small class="fs-sm text-muted">/Month</small>
              </h2>
            </div>
          </div>
          <p class="text-muted">
            Excellent for scaling teams to build culture. Special plan for
          ...
          <div class="mt-3 pt-2">
            <BLink href="#" class="btn btn-info w-100">Change Plan</BLink>
          </div>
        </BCardBody>
      </BCard>
    </BCol>
    ...
    <BCol xxl="3" lg="6">
      <BCard
        no-body
        class="card-animate border-0 border-top border-2 border-primary rounded-0 rounded-bottom"
      >
        <BCardBody class="m-2 p-4">
          <div class="d-flex align-items-center mb-3">
            <div class="flex-grow-1">
            ...
            <div class="ms-auto">
              <h2 class="mb-0">
                $39 <small class="fs-sm text-muted">/Month</small>
              </h2>
            </div>
          </div>
          <p class="text-muted">
    ...
    <BCol xxl="3" lg="6">
      <BCard
        no-body
        class="card-animate border-0 border-top border-2 border-info rounded-0 rounded-bottom"
      >
        <div
          class="p-1 bg-info bg-opacity-10 text-center text-info fw-semibold"
        >
          <span
            ><i class="ri-flashlight-fill align-bottom me-1" /> Most Popular
            Choice</span
          >
        </div>
        <BCardBody class="m-2 p-4">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
              <h2 class="mb-0">
                $49 <small class="fs-sm text-muted">/Month</small>
              </h2>
            </div>
          </div>
          <p class="text-muted">
  ...
  <BRow>
    <BCol xxl="4" lg="6">
      <BCard no-body class="overflow-hidden">
        <BRow class="g-0">
          <BCol lg="5">
            <BCardBody class="bg-success-subtle h-100 d-flex flex-column">
              <div>
                <h5>Starter</h5>
                <p>Starter plans</p>
              </div>
              ...
              <div class="pt-3 mt-auto">
                <h2 class="text-success mb-0">
                  $24.99
                  <span class="fs-xs fw-normal text-success opacity-75">
                    /Per month</span
                  >
                </h2>
              </div>
          ...
          <BCol lg="7">
            <BCardBody class="h-100">
              <ul class="list-unstyled vstack gap-3 mb-4">
                <li>
                  <i class="bi bi-check2-square text-success me-1" /> Users:
                  <span class="fw-semibold">1</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-success me-1" /> Storage:
                  <span class="fw-semibold">01 GB</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-success me-1" /> Domain:
                  <span class="fw-semibold">No</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-success me-1" /> Support:
                  <span class="fw-semibold">No</span>
                </li>
              </ul>
    ...
    <BCol xxl="4" lg="6">
      <BCard no-body class="overflow-hidden ribbon-box right">
        <div class="ribbon ribbon-danger round-shape">Hot</div>
        <BRow class="g-0">
          <BCol lg="5">
            <BCardBody class="bg-primary-subtle h-100 d-flex flex-column">
              <div>
                <h5>Professional</h5>
              ...
              <div class="pt-3 mt-auto">
                <h2 class="text-primary mb-0">
                  $49.99
                  <span class="fs-xs fw-normal text-primary opacity-75">
                    /Per month</span
                  >
                </h2>
              </div>
          ...
          <BCol lg="7">
            <BCardBody class="h-100">
              <ul class="list-unstyled vstack gap-3 mb-4">
                <li>
                  <i class="bi bi-check2-square text-primary me-1" /> Users:
                  <span class="fw-semibold">1</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-primary me-1" /> Storage:
                  <span class="fw-semibold">5 GB</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-primary me-1" /> Domain:
                  <span class="fw-semibold">Yes</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-primary me-1" /> Support:
                  <span class="fw-semibold">No</span>
                </li>
              </ul>
    ...
    <BCol xxl="4" lg="6">
      <BCard no-body class="overflow-hidden">
        <BRow class="g-0">
          <BCol lg="5">
            <BCardBody class="bg-secondary-subtle h-100 d-flex flex-column">
              <div>
                <h5>Unlimited</h5>
                <p>Unlimited plans</p>
              </div>
              ...
              <div class="pt-3 mt-auto">
                <h2 class="text-secondary mb-0">
                  $99.99
                  <span class="fs-xs fw-normal text-secondary opacity-75">
                    /Per month</span
                  >
                </h2>
              </div>
          ...
          <BCol lg="7">
            <BCardBody class="h-100">
              <ul class="list-unstyled vstack gap-3 mb-4">
                <li>
                  <i class="bi bi-check2-square text-secondary me-1" /> Users:
                  <span class="fw-semibold">5</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-secondary me-1" />
                  Storage: <span class="fw-semibold">40 GB</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-secondary me-1" />
                  Domain: <span class="fw-semibold">Yes</span>
                </li>
                <li>
                  <i class="bi bi-check2-square text-secondary me-1" />
                  Support: <span class="fw-semibold">Yes</span>
                </li>
              </ul>
